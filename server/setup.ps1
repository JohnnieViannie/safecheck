...
Write-Host ''
Write-Host 'For server-driven check-in pushes, set FIREBASE_CREDENTIALS_PATH in .env'
Write-Host 'then run the scheduler loop in a second terminal:'
Write-Host '  .\run_scheduler.ps1'
